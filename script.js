...
const galleryData = [
  ...
  { category: 'posters', title: 'Poster 1', image: 'works/posters1.png', description: 'My first poster' },
  { category: 'posters', title: 'Poster 2', image: 'works/posters2.png', description: 'Another poster' },
...
if (galleryContainer) { // перевіряємо, чи існує контейнер
